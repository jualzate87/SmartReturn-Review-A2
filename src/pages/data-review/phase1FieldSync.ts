...
/**
 * ProtoA2: no orange import field flags — document verification only.
 * Navigation helpers below remain for field/source linking; flag counts are always zero.
 */
export const PHASE1_FLAG_KEYS = [] as const

export type Phase1FlagKey = string
...
/** Ordered Verify queue — empty in ProtoA2 (no field flags to walk). */
...
/** Phase 1 import flags per W-2 employer — none in ProtoA2. */
const W2_PAYER_FLAG_KEYS: Record<W2Employer, Phase1FlagKey[]> = {
  techCircle: [],
  bingEquipment: [],
}

/** Phase 1 import flags per 1099-DIV payer — none in ProtoA2. */
...
/** Phase 1 import flags per 1099-R payer — none in ProtoA2. */
const R_PAYER_FLAG_KEYS: Record<'meridian', Phase1FlagKey[]> = {
  meridian: [],
}

/** Phase 1 import flags per 1099-INT payer — none in ProtoA2. */
...
/** Summary 1040 field → related Phase 1 import flags — none in ProtoA2. */
